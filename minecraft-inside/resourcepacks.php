...
$stmt = $pdo->query("
    ...
    WHERE f.status = 'approved' AND c.type = 'resourcepacks'
...
<div class="container">
    <h1>Ресурспаки для Minecraft</h1>
    <p>Измените текстуры и звуки вашей игры с помощью наших ресурспаков</p>
    
    <div class="files-grid">
        <?php if(empty($files)): ?>
            <div class="no-results">
                <h3>Ресурспаков пока нет</h3>
                <p>Будьте первым, кто <a href="upload.php">добавит ресурспак</a></p>
            </div>
        <?php else: ?>
